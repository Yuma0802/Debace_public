...
「Debace」は以上のような課題を解決し、オンライン上に建設的な議論を行う場所を提供します。


### 概要説明
「Debace」はオンライン上で建設的な議論を行う場所です。
アカウントを登録することで議論を作成したり、参加することができます。
...
### 開発で工夫したこと
- Firestoreの特徴を活かし、できるだけ表示と同じ形でデータベースに登録することでデータベースの取得、書き込み回数を最低限に抑えられるように設計、実装した。
...
- モバイル端末でも使用できるようにレスポンシブデザインを意識して実装した。
