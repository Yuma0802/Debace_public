...
const SPostReplyNameWrap = styled.div`
  position: relative;
  padding-top: 5px;
  padding-left: 20px;
`;

const SPostReplyName = styled.p`
  display: flex;
  height: 25px;
  font-size: 20px;
  font-weight: bold;
...
const SPopup = styled.div`
  position: absolute;
  top: 50px;
  left: calc(-0% - 10px); // adjust the value to move the component
  border: solid 3px;
  border-color: orange;
