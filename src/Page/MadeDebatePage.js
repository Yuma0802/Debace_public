  ...
  useEffect(() => {(async() => {
    if(userT){
      try{
        let preElementList = []
        let preCount = 0
        const collectionRef = collection(db,'users',userId,'made')
  ...
  return (
    <>
      ...
      <SSelectBoxWrap>
        ...
        <SFavoriteDebateTitle>作成した議論</SFavoriteDebateTitle>
